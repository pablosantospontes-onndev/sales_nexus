...
$queueContextParams = [
    ...
    'base_group' => ($baseGroupFilter ?? []) !== [] ? $baseGroupFilter : null,
    'supervisor' => ($supervisorFilter ?? []) !== [] ? $supervisorFilter : null,
    'coordinator' => ($coordinatorFilter ?? []) !== [] ? $coordinatorFilter : null,
    'manager' => ($managerFilter ?? []) !== [] ? $managerFilter : null,
